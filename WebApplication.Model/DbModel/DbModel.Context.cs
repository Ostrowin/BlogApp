...
namespace WebApplication.Model.DbModel
{
    ...
    public partial class testEntities : DbContext
    {
        ...
        public virtual DbSet<PushUps> PushUps { get; set; }
        public virtual DbSet<TestPersons> TestPersons { get; set; }
        ...
        [DbFunction("testEntities", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[testEntities].[ufnGetAllCategories]()");
        }
    
        [DbFunction("testEntities", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[testEntities].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
